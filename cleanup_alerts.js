...
// The CLEAN, PRODUCTION-READY body we want
const cleanFunctionBody = `function centerMapOnFortress() {
...
try {
    ...
    // Replace content
    const newContent = content.substring(0, startIdx) + cleanFunctionBody + content.substring(endIdx);

    fs.writeFileSync(filePath, newContent, 'utf8');
    console.log('Successfully cleaned up centerMapOnFortress logic!');
